...
class ProjectListPage(BasePage):
    FIND_TASK_TO_DELETE =(By.XPATH,"//div[@class='fb8d74bb _14423c92 _5f8879d9 _202b0c8c b76144ce a65d9c55 _2580a74b']/div[@id='2329550905-label' and text()='test delete Project task']")
